  ...
  return (
    <header
      className={cn(
        ...
        scrolled ? cn(line, glass, 'shadow-[0_1px_20px_-12px_rgba(9,9,20,0.35)]') : 'border-transparent',
      )}
    >
      <nav className={cn(container, 'flex h-16 items-center justify-between gap-4')}>
        <a href="#top" className={cn('rounded-xl', focusRing)} aria-label="Swifty home">
          <Logo />
        </a>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <a href="#install" className={cn(primaryButton, 'hidden h-9 px-4 sm:inline-flex', focusRing)}>
            Get started
