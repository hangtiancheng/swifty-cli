...
export function Install() {
  const [active, setActive] =
    useState<(typeof INSTALL_METHODS)[number]["id"]>("curl");
  const method =
    INSTALL_METHODS.find((item) => item.id === active) ?? INSTALL_METHODS[0];
        ...
        <div className="border-brand-500/15 bg-brand-50 relative overflow-hidden rounded-3xl border px-6 py-12 text-center sm:px-12 sm:py-16 dark:border-transparent dark:bg-white/[0.04]">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-4 max-w-xl text-sm text-zinc-600 sm:text-base dark:text-zinc-400">
              Point it at your repository, describe what you want, and watch it
              plan, edit and verify — with you in control of every write.
            </p>
