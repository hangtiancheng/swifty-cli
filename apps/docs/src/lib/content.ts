...
export const INSTALL_METHODS = [
  ...
  { id: 'npm', label: 'npm', hint: 'Node.js 20+', command: 'npm install -g @swifty.js/swifty' },
  { id: 'pnpm', label: 'pnpm', hint: 'Node.js 20+', command: 'pnpm add -g @swifty.js/swifty' },
] as const

export const QUICK_COMMANDS = [
  { command: 'swifty', label: 'Interactive TUI', tone: 'brand' },
  { command: 'swifty -p "explain this codebase"', label: 'Print mode', tone: 'accent' },
...
export const agentCards: AgentCard[] = [
  {
    ...
    role: 'Executor',
    description: 'Researches complex questions, explores the codebase and runs multi-step tasks.',
    icon: Zap,
  ...
  },
  {
    name: 'plan',
    role: 'Architect',
    description: 'Read-only planning. Understands requirements and designs the solution before code.',
    icon: ListTree,
  ...
  },
  {
    name: 'explore',
    role: 'Scout',
    description: 'Fast code exploration with parallel Glob, Grep and ReadFile calls.',
    icon: Search,
