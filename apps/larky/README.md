...
apps/larky/
  ...
  kill.mjs                    Force-kill all larky processes
...
| ~/.larky/sessions/                    | Session data: meta.json, thread.jsonl, notes.md, summary\_\*.md |
| ~/.larky/sessions/{sid}/runs/{runId}/ | Per-run event logs                                              |
| ~/.larky/traces/daemon.jsonl          | Trace log (NDJSON)                                              |
| ~/.larky/logs/core.log                | Application log (Pino)                                          |
| ~/.larky/larky-core.pid               | Daemon PID file                                                 |
| ~/.larky/agents/{name}.toml           | User-defined agent profiles                                     |
| .larky/config.toml                    | Project-local configuration                                     |
| .larky/context.md                     | Project-local context                                           |
| .larky/agents/{name}.toml             | Project-local agent profiles                                    |
