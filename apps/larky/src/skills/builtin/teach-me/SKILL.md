...
All teach-me data is stored under `.larky/skills/teach-me/records/`:

```
.larky/skills/teach-me/records/
...
3. Load learner profile if `.larky/skills/teach-me/records/learner-profile.md` exists.
...
5. Create output directory: `.larky/skills/teach-me/records/{topic-slug}/`
...
3. Update `.larky/skills/teach-me/records/learner-profile.md` (keep under 30 lines):
